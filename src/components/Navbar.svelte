  ...
  <div class="max-w-6xl mx-auto px-4">
    <div class="flex justify-between items-center py-4">
      ...
      <div class="hidden md:flex items-center space-x-1">
        ...
        <a href="/courses" class="py-5 px-3 transition duration-300">Cursos</a>
        <!-- Highlighted -->
      </div>
      ...
      <button
        ...
        class="hidden md:block px-3 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 transition duration-300"
      >
